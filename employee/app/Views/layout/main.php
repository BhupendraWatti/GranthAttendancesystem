    ...
    <div class="app-layout">
        ...
        <aside class="sidebar">
            ...
            <div style="margin-top: auto;">
                <a href="<?= site_url('auth/logout') ?>" class="sidebar-nav"
                    style="text-decoration: none; color: var(--color-text-dim); font-size: 0.9rem; display: flex; align-items: center; gap: 1rem; padding: 1rem;">
        ...
        <main class="main-wrapper">
            ...
            <?php if (session()->getFlashdata('success')): ?>
                <div
                    style="background: rgba(16, 185, 129, 0.1); color: #10B981; padding: 1rem 2rem; border-radius: var(--radius-md); margin-bottom: 2rem; border: 1px solid rgba(16, 185, 129, 0.2);">
            ...
            <?php if (session()->getFlashdata('error')): ?>
                <div
                    style="background: rgba(239, 68, 68, 0.1); color: #EF4444; padding: 1rem 2rem; border-radius: var(--radius-md); margin-bottom: 2rem; border: 1px solid rgba(239, 68, 68, 0.2);">
            ...
            <footer
                style="margin-top: 6rem; padding-top: 2rem; border-top: 1px solid var(--color-border); color: var(--color-text-dim); font-size: 0.8rem; text-align: center;">
