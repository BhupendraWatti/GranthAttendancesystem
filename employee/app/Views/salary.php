...
<div style="display: grid; grid-template-columns: repeat(12, 1fr); gap: 1.5rem;">
    ...
    <div style="grid-column: span 8; display: flex; flex-direction: column; gap: 1.5rem;">
        <div class="card"
            style="padding: 3rem; background: var(--color-primary); color: white; border: none; overflow: hidden; position: relative;">
            <div
                style="position: absolute; top: -10%; right: -5%; width: 240px; height: 240px; background: var(--color-accent); filter: blur(100px); opacity: 0.2;">
            </div>
            ...
            <div
                ...
                <div>
                    <span
                        style="font-size: 0.7rem; font-weight: 700; text-transform: uppercase; color: rgba(255,255,255,0.5); letter-spacing: 0.1em; display: block; margin-bottom: 0.5rem;">Net
                        Remuneration</span>
                    <h3 style="font-family: var(--font-display); font-size: 3.5rem; line-height: 1;">
                        ₹<?= number_format($salary['net_salary'] ?? 0, 2) ?></h3>
                </div>
                <div style="text-align: right;">
                    <div style="font-size: 0.8125rem; font-weight: 600; color: rgba(255,255,255,0.7);">
                        <?= date('F Y', mktime(0, 0, 0, $month, 1, $year)) ?></div>
                    <span class="badge"
                        style="background: rgba(16, 185, 129, 0.2); color: #4ADE80; margin-top: 0.5rem;">Finalized</span>
                </div>
            </div>

            <div
                style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; position: relative; z-index: 1; padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.1);">
                <div>
                    <label
                        style="font-size: 0.65rem; font-weight: 700; text-transform: uppercase; color: rgba(255,255,255,0.4); display: block; margin-bottom: 0.5rem;">Base
                        Salary</label>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="<?= site_url("salary/payslip?month={$month}&year={$year}") ?>" class="btn btn-primary"
                    style="padding: 0.5rem 1.25rem; font-size: 0.75rem;">Generate Full Payslip</a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr style="background: var(--color-surface-muted);">
                            <td colspan="2"
                                ...
                                Total Net Remuneration</td>
                            <td
                                style="text-align: right; font-weight: 700; font-size: 1rem; color: var(--color-accent);">
                                ₹<?= number_format($salary['net_salary'] ?? 0, 2) ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div style="grid-column: span 4; display: flex; flex-direction: column; gap: 1.5rem;">
        <div class="card">
            ...
            <div class="card-body">
                <form method="get" action="<?= site_url('salary') ?>"
        ...
        <div class="card" style="background: #EFF6FF; border-color: #BFDBFE;">
            ...
            <div class="card-body">
                <p style="font-size: 0.8125rem; line-height: 1.6; color: #1E40AF;">For enquiries regarding your
                    statement of earnings, please submit a formal ticket to the <span
                        style="font-weight: 700;">Financial Registry</span> within 72 hours of publication.</p>
            </div>
        </div>
    </div>
</div>
