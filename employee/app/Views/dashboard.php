...
<div class="stats-grid">
    ...
    <div class="stat-card">
        ...
        <span class="text-muted"
            style="font-size: 0.8125rem; margin-top: 0.25rem;"><?= esc($employee['designation'] ?? 'personal Associate') ?></span>
        <span class="stat-sub"
            ...
            <tbody>
                <?php foreach ($recent as $row): ?>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 600; color: var(--color-primary);"><?= esc($row['total_hours'] ?? '0') ?>h
                        </td>
                    </tr>
                <?php endforeach; ?>
                <?php if (empty($recent)): ?>
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 3rem; color: var(--color-text-dim);">No recent
