...
<head>
    ...
    <title>Payslip — <?= esc($employee['name'] ?? '') ?> — <?= date('F Y', mktime(0,0,0,$month??1,1,$year??2026)) ?></title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .net-salary-box {
            ...
            color: white; padding: 20px 28px; border-radius: 12px; margin-top: 24px;
        }
    ...
    <div class="earnings-grid">
        ...
        <div>
            ...
            <table class="earn-table">
                ...
                <tr class="total-row"><td>Total Deductions (B)</td><td class="text-right font-mono"><?= $currency ?><?= number_format($deduction + ($sal['admin_deduction'] ?? 0), 2) ?></td></tr>
            </table>
        </div>
    </div>
