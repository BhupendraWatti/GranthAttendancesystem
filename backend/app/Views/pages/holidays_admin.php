        ...
        <div class="card h-full"
            ...
            <div class="card-header">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <div
                        style="width: 40px; height: 40px; border-radius: var(--radius-md); background: linear-gradient(135deg, var(--color-success) 0%, #34D399 100%); display: flex; align-items: center; justify-content: center; color: white;">
                        <i class="fa-solid fa-plus"></i>
                    </div>
                    <div>
                        <h3 style="margin: 0;">Add New Event</h3>
                        <div style="font-size: 0.75rem; color: var(--color-text-dim);">Schedule holidays and events
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-header">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <div>
                        ...
                        <div style="font-size: 0.75rem; color: var(--color-text-dim);"><?= count($holidays ?? []) ?>
                    ...
                    <table style="border: none;">
                        <thead>
                            <tr
                                ...
                                <th style="border: none; padding: 1rem 1.5rem;">Event Date</th>
                                <th style="border: none; padding: 1rem 1.5rem;">Event Title</th>
                                <th style="border: none; padding: 1rem 1.5rem;">Type</th>
                                    ...
                                    <tr style="border-bottom: 1px solid var(--color-border); transition: all 0.2s;">
                                        <td style="padding: 1.25rem 1.5rem;">
                                            <div style="display: flex; align-items: center; gap: 1rem;">
                                                <div
                                                    style="width: 48px; height: 48px; border-radius: var(--radius-md); background: linear-gradient(135deg, var(--color-accent) 0%, #6366f1 100%); display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 0.875rem;">
                                                    <?= date('d', strtotime($h['date'])) ?>
                                                </div>
                                                <div>
                                                    <div
                                                        style="font-weight: 700; color: var(--color-primary); font-size: 0.9375rem;">
                                                        <?= date('d M Y (D)', strtotime($h['date'])) ?></div>
                                                    <div
                                        ...
                                        <td style="padding: 1.25rem 1.5rem;">
                                            ...
                                            ?>
                                            <span class="tag tag--<?= $typeClass ?>"
                                                style="font-size: 0.7rem; padding: 0.375rem 0.875rem;">
                                                <i class="fa-solid <?= $typeIcon ?>" style="margin-right: 0.25rem;"></i>
                                                <?= esc(ucfirst(str_replace('_', ' ', $h['type']))) ?>
                                            </span>
                                        </td>
                                        <td style="padding: 1.25rem 1.5rem; text-align: right;">
                                            <form action="<?= site_url('holidays/delete') ?>" method="POST"
                                    ...
                                    <td colspan="4" style="text-align: center; padding: 4rem;">
                                        <div class="empty-state"
                                            ...
                                            <div>
                                                ...
                                                <p style="font-size: 0.875rem; color: var(--color-text-dim);">Add your first
                                                    holiday or company event using the form on the left.</p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
